...
package com.example.danie.atividade;
...
public class Utils {
    ...
    private static com.example.danie.atividade.StatusTracker mStatusTracker = com.example.danie.atividade.StatusTracker.getInstance();
